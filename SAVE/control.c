...
{
	ctrl.roll.core.kp= Rc_Data->AUX2;
	ctrl.pitch.core.kp= Rc_Data->AUX3;
	ctrl.yaw.core.kp= Rc_Data->AUX4;
}
void PID_control(void)
{
//	PID_Test(&Rc_Data);
	ctrl.roll.core.kp_out=  ctrl.roll.core.kp * (float)(Rc_Data.ROLL - Rc_Data.roll_offset)/20.0f;
	ctrl.roll.core.kd_out = ctrl.roll.core.kd * (sensor.gyro.radian1.x  - sensor.gyro.histor.x);
	
	ctrl.pitch.core.kp_out=  ctrl.pitch.core.kp * (float)(Rc_Data.PITCH - Rc_Data.pitch_offset)/20.0f;
	ctrl.pitch.core.kd_out = ctrl.roll.core.kd * (sensor.gyro.radian1.y  - sensor.gyro.histor.y);
	
	ctrl.yaw.core.kp_out = ctrl.yaw.core.kp * (((float)Rc_Data.YAW - Rc_Data.yaw_offset)/20.f);
